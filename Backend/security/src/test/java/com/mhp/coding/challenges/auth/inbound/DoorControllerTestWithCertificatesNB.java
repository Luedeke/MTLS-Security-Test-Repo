...
public class DoorControllerTestWithCertificatesNB {
    ...
    private static final String ADMIN_KEYS_TORE_NB = "C:/Users/Nils-NB/Google Drive/MHP/coding-challenges/" +
            "Backend/security/src/main/resources/client-admin.jks";

    private static final String GATEWAY_KEY_STORE_NB = "C:/Users/Nils-NB/Google Drive/MHP/coding-challenges/" +
    ...
    public void test_get_all_doors_accept_all_cert_should_fail() throws Exception {
        ...
        keyStore.load(new FileInputStream(USER_KEY_STORE_NB), KEY_PASSPHRASE.toCharArray());
    ...
    private HttpClient getSSLHttpClientWithUnknownUserCertificate() throws KeyStoreException, IOException, NoSuchAlgorithmException,
            CertificateException, KeyManagementException, UnrecoverableKeyException {
        return getHttpClient(GATEWAY_KEY_STORE_NB);
    }
